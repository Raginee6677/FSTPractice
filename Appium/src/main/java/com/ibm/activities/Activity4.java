...
public class Activity4 {
	...
	public void createContact() {
		...
		driver.findElementByXPath("//android.widget.EditText[@text='First name']").sendKeys("Raginee");
		driver.findElementByXPath("//android.widget.EditText[@text='Last name']").sendKeys("Singh");
		driver.findElementByXPath("//android.widget.EditText[@text='Phone']").sendKeys("9710025243");
        ...
        Assert.assertEquals(contactName, "Raginee Singh");
	}
