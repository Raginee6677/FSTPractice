...
//Goal: Opening a page on the browser and 
//testing a simple login page with correct and incorrect credentials
...
public class Activity6 {
	...
	public void LoginSimpleForm() {
		...
		driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
		driver.findElement(MobileBy.xpath("//android.view.View[@content-desc=\"Popups Tooltips and Modals\"]")).click();
		// Once the page loads, find the Sign In button on the page to open a popup with
		// the login form.
		...
		String successMess = driver.findElement(MobileBy.AndroidUIAutomator("resourceId(\"action-confirmation\")"))
				.getText();
		...
		driver.findElement(
				By.xpath("//android.webkit.WebView/android.view.View/android.view.View[4]/android.widget.Button"))
				.click();
		...
		String failureMess = driver.findElement(MobileBy.AndroidUIAutomator("resourceId(\"action-confirmation\")"))
				.getText();
