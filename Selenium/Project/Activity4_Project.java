...
public class Activity4_Project {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		Thread.sleep(4000);
		java.util.List<WebElement> wl=driver.findElements(By.xpath("//h3[@class='entry-title']"));
		System.out.println(wl.size());
		String firstInfoBox = wl.get(1).getText();
		if (firstInfoBox.equalsIgnoreCase("Email Marketing Strategies")) {
		Thread.sleep(4000);	
		System.out.println(" it matches ““Email Marketing Strategies” exactly ");
		driver.quit();}
