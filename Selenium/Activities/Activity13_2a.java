...
public class Activity13_2a {
	    ...
	    public void writeExcel(String filePath) throws IOException {
	        ...
	        String[] row1 = {"1", "Abhishek", "Sharma", "asharma@example.com", "9038999909"};
	        String[] row2 = {"2", "Avinash", "Chauhan", "avinashc@example.com", "97087996543"};
	        String[] row3 = {"3", "Raginee", "Singh", "raginee.singh@example.com", "9903092378"};
